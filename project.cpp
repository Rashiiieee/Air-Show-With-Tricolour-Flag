...
void front()
{
	...
	output(250,650,"JSS Academy Of Technical Education",fonts[2]);
	glColor3f(1.0,1.0,0.0);
	...
	output(250,350,"1] Rashika Khare (1JS19CS136)",fonts[2]);
	output(650,350,"2] Teliki Sai Jyothsna (1JS19CS181)",fonts[2]);
...
void help()
{
	...
	glColor3f(0.5,0.2,0.6);
	output(600,60,"[ Dept. of CSE, JSSATE ]",fonts[0]);
}
void intro()
{
	glColor3f(0.8,0.1,0.2);
